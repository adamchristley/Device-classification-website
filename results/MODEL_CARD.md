...
- Version: `clip-linear-wikimedia-v0.1-2026-08-02`
...
- Accuracy: **30.0%**
- Macro F1: **0.302**
- Selective coverage: **73.3%**
- Accuracy among answered examples: **22.7%**

| Class | Support | Precision | Recall | F1 |
|---|---:|---:|---:|---:|
| Analog / Mechanical | 8 | 0.571 | 0.500 | 0.533 |
| Digital / Electronic | 8 | 0.154 | 0.250 | 0.190 |
| Software Controlled | 8 | 0.500 | 0.125 | 0.200 |
| Hybrid | 6 | 0.250 | 0.333 | 0.286 |

## Abstention rule

The site returns **Indeterminate** when the maximum class probability is below 0.425 or the top-two probability margin is below 0.150. These thresholds were selected only on the validation split with a minimum 60% validation coverage requirement.
